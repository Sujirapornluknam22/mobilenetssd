...
lineaccesstoken = 'lm2rpcZd3JNPZI4vSO2R48fPQ2E+UltwtTMzqVXjB4+gSldicpkXFKAYAicWMrTIwwYtEbXI7BWz3C+ZkV+jiZ99lipu0C8QZ/CmeYuGO48iiLAyqvSVQ3ohkHglj9ZQJQSvwmkPT4IwUzcVacVz0AdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" : 
            replyObj = TextSendMessage(text="ดีๆ")
        elif msg == "กินข้าวไหม" : 
            replyObj = TextSendMessage(text="ม่ายยกิน")
        elif msg == "ไปเที่ยวกันมั้ย" :
            replyObj = TextSendMessage(text="ไปดิไป")
        elif msg == "พี่วอร์น่ารัก" :
            replyObj = TextSendMessage(text="พี่วอร์น่ารัก")
        line_bot_api.reply_message(rtoken, replyObj)
    elif msgType == "image":
        try:
